...
function render(variables = {}) {
  ...
  if (variables.includeCover == false)
    cover = `<div class="cover"><img src="${variables.background2}" /></div>`;
...
window.onload = function() {
  window.variables = {
    ...
    background2:
      "https://fotografias.lasexta.com/clipping/cmsimages02/2022/03/17/8817DB4C-0E8F-47FF-A87F-DF95C9FDC014/grace-bay-beach_97.jpg?crop=1253,705,x0,y67&width=1600&height=900&optimize=high&format=webply",
